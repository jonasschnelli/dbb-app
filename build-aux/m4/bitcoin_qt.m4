...
AC_DEFUN([_BITCOIN_QT_FIND_LIBS_WITH_PKGCONFIG],[
  ...
  if test x$auto_priority_version = x; then
    ...
    qt5_modules="Qt5Core Qt5Gui Qt5Network Qt5Widgets Qt5WebSockets"
...
AC_DEFUN([_BITCOIN_QT_FIND_LIBS_WITHOUT_PKGCONFIG],[
  ...
  BITCOIN_QT_CHECK([
    if test x$qt_include_path != x; then
      QT_INCLUDES="-I$qt_include_path -I$qt_include_path/QtCore -I$qt_include_path/QtGui -I$qt_include_path/QtWidgets -I$qt_include_path/QtNetwork -I$qt_include_path/QtWebSockets -I$qt_include_path/QtTest -I$qt_include_path/QtDBus"
      CPPFLAGS="$QT_INCLUDES $CPPFLAGS"
    fi
  ])
  ...
  BITCOIN_QT_CHECK(AC_CHECK_LIB([${QT_LIB_PREFIX}WebSockets],[main],,BITCOIN_QT_FAIL(lib$QT_LIB_PREFIXWebSockets not found)))
  if test x$bitcoin_qt_got_major_vers = x5; then
